<?php
    $to = "robotlearningpapers@gmail.com";
    $from = $_REQUEST['email'];
    $name = $_REQUEST['name'];
...
<body>
<div class="col-lg-4">
                <div class="sharediv" style="position:fixed;top:340px;right:10px;width:60px;"><button style = "background-image: url(img/facebook.png);width:50px; height:50px;" onclick = "window.open('https://www.facebook.com/sharer/sharer.php?u=https://www.bohg.cs.stanford.edu');
	    return false;"></button>
  ...
  <section class="contact-section section_padding">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="contact-title">Thank You For Your Note! Your Message Has Been Sent.</h2>
